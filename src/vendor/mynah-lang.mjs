 ...
 * Commit:    6272e7799dee33de6952d9d6c9242d6ffb6d8e9d
 * Synced:    2026-09-12
 * SHA-256:   5459ce4c6a3e9dadb47b8988e015227621754796211f362e09f9687b0ee5b4d5
 *
...
function compile(cmd, ctx = {}) {
	...
	const paths = p.paths;
	if (cmd.audio) {
		if (!p.audio) return fail(`Audio patching is written against LivePremier's matrix, which ${p.name} does not have`);
